...
type MapMarkerProps = RouteComponentProps<any, StaticContext> & WithTheme & MarkerProps & {
  title: string
}
...
class MapMarker extends React.Component<MapMarkerProps> {
  ...
  public render(): React.ReactNode {
    /**
     * The div->svg block is copied from html of non-react mapbox version.
     */
    return (
      <Marker 
      ...
      >
        <div className="mapboxgl-marker mapboxgl-marker-anchor-center" style={markerStyle} onClick={this.onClick}>
...
export default withTheme(withRouter(MapMarker));