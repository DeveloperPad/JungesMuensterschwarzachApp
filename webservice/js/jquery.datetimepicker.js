        ...
        var picker = {},
            ...
            _doTimeInc = function(timetable, input){
                ...
                if (inputType === 'h') {
                    ...
                    var minutes = (displayDate.getMinutes() + 1) % 60;
                    displayDate.setMinutes(minutes);
                    timetable.$m.val(utilsLeftPad(minutes, 2, '0'));
                } else {
                    var seconds = (displayDate.getSeconds() + 1) % 60;
            ...
            _doTimeDec = function(timetable, input){
                ...
                if (inputType === 'h') {
                    ...
                    var minutes = (displayDate.getMinutes() + 59) % 60;
                    displayDate.setMinutes(minutes);
                    timetable.$m.val(utilsLeftPad(minutes, 2, '0'));
                } else {
                    var seconds = (displayDate.getSeconds() + 59) % 60;
                    displayDate.setSeconds(seconds);
                    timetable.$s.val(utilsLeftPad(seconds, 2, '0'));
                }
                input.select();
