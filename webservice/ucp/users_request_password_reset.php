<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["eMailAddress"]) === true) {
		try {
			...
			CookieModule::set("alert", new Alert("success", $GLOBALS["dict"]["mail_password_reset_sent"]));
	...
	<body>
		...
		<div class="container">
			...
			<div class="jumbotron jma-background-color">
				<h1 class="mb-4"><?php echo($GLOBALS["dict"]["navigation_request_password_reset"]);?></h1>
				<hr>
				<form name="requestPasswordResetForm" method="POST" class="form-horizontal">
