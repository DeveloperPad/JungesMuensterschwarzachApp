<?php
	...
	if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["eMailAddress"]) === true) {
		try {
			...
			// success alert gets set in requestAccountTransferMail()
	...
	<body>
		...
		<div class="container">
			...
			<div class="jumbotron jma-background-color">
				<h1 class="mb-4"><?php echo($GLOBALS["dict"]["navigation_request_account_transfer_mail"]);?></h1>
				<hr>
				<form name="accountTransferMailForm" method="POST" class="form-horizontal">
